...
#
# Script generated by Vivado on Mon May 18 06:21:40 CEST 2026
...
#
# Usage        : singen.sh
#                singen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                singen.sh [-reset_run]
#                singen.sh [-reset_log]
#                singen.sh [-help]
#
...
#                script (type 'singen.sh -help' for more information).
#
...
# script info
echo -e "singen.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./singen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.singen xil_defaultlib.glbl -o singen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./singen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key singen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc singen_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./singen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: singen.sh [-help]\n\
Usage: singen.sh [-step]\n\
Usage: singen.sh [-lib_map_path]\n\
Usage: singen.sh [-reset_run]\n\
Usage: singen.sh [-reset_log]\n\
Usage: singen.sh [-keep_index]\n\
Usage: singen.sh [-noclean_files]\n\n\
