...
#
# Script generated by Vivado on Mon May 18 17:57:19 CEST 2026
...
#
# Usage        : vram.sh
#                vram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vram.sh [-reset_run]
#                vram.sh [-reset_log]
#                vram.sh [-help]
#
...
#                script (type 'vram.sh -help' for more information).
#
...
# script info
echo -e "vram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vram -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jak_jan/subjects/ISP/lab8a/lab8a.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: vram.sh [-reset_log]\n\
Usage: vram.sh [-keep_index]\n\
