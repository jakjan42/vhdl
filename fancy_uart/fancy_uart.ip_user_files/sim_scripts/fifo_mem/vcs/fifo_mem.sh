...
#
# Script generated by Vivado on Sat May 23 17:33:12 CEST 2026
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_mem.sh
...
#
# Usage        : fifo_mem.sh
#                fifo_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_mem.sh [-reset_run]
#                fifo_mem.sh [-reset_log]
#                fifo_mem.sh [-help]
#
...
#                script (type 'fifo_mem.sh -help' for more information).
#
...
# script info
echo -e "fifo_mem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_mem xil_defaultlib.glbl -o fifo_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_mem_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jak_jan/subjects/ISP/test/test.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fifo_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_mem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_mem.sh [-help]\n\
Usage: fifo_mem.sh [-step]\n\
Usage: fifo_mem.sh [-lib_map_path]\n\
Usage: fifo_mem.sh [-reset_run]\n\
Usage: fifo_mem.sh [-reset_log]\n\
Usage: fifo_mem.sh [-keep_index]\n\
Usage: fifo_mem.sh [-noclean_files]\n\n\
