...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot char_mem xil_defaultlib.char_mem -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim char_mem -key {Behavioral:sim_1:Functional:char_mem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb char_mem.wdb xsim.dir libdpi.so)
