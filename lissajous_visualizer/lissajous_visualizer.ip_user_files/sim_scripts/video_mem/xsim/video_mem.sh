...
#
# Script generated by Vivado on Mon May 11 01:22:47 CEST 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot video_mem xil_defaultlib.video_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim video_mem -key {Behavioral:sim_1:Functional:video_mem} -tclbatch cmd.tcl -log simulate.log
}
